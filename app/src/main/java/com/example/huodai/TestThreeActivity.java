    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.btn_next)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(TestThreeActivity.this,TestActivity.class);
                startActivity(intent);
            }
        });

        detailLinearLayout = ((LinearLayout) findViewById(R.id.detail_lin));

        ((CheckBox) findViewById(R.id.check_show)).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
